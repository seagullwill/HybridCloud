...
public abstract class CloudletScheduler {
	...
	private Map<Integer, Double> execTimeList;

	/** The current mips share. */
	private List<Double> currentMipsShare;
	private double nextSlot=CloudSim.clock();
	/**
	...
	public double getCurrentAvailableCpu(){
		return Double.MAX_VALUE;
	}
	public double getCurrentAvailableTrans(){
		return Double.MAX_VALUE;
	}

	public double getNextSlot() {
		return nextSlot;
	}

	public void setNextSlot(double nextSlot) {
		this.nextSlot = nextSlot+CloudSim.clock();
	}

	public Map<Integer, Double> getExecTimeList() {
		return execTimeList;
	}
}
