...
public class Datacenter extends SimEntity {
		...
		if (cl == null) {// cloudlet doesn't exist
			...
			if (destId == getId()) {
				...
				if (vm == null) {
					...
					double fileTransferTime = predictFileTransferTime(cl,vm);
	...
	protected double predictFileTransferTime(Cloudlet cl,Vm vm) {
		return (cl.getCloudletFileSize()+cl.getCloudletOutputSize())/vm.getCloudletScheduler().getCurrentAvailableTrans();		
	}
